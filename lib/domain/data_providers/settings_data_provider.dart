...
class SettingsDataProvider {
  ...
  Future<void> initialize() async {
    if (await _secureStorage.containsKey(key: _Keys.sensitiveContent) ==
        false) {
  ...
  void setSensitiveContentSettings(bool value) {
    _secureStorage.write(key: _Keys.sensitiveContent, value: value.toString());
  }

  Future<bool> getSensitiveContentSettings() async {
    return bool.parse(
        await _secureStorage.read(key: _Keys.sensitiveContent) ?? "false");
  }
}
