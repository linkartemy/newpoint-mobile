...
class MarkdownFormField extends StatefulWidget {
  ...
  final Function(String text, String? href, String title)? onTapLink;

  /// Called when a hashtag is tapped
  final Function(String name, String match)? onTapHashtag;

  /// Called when a mention is tapped
  final Function(String name, String match)? onTapMention;
