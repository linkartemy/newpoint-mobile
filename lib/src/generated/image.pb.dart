...
class AddImageRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AddImageRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'image'), createEmptyInstance: create)
...
class AddImageResponse extends $pb.GeneratedMessage {
  factory AddImageResponse({
    $fixnum.Int64? id,
  }) {
    final $result = create();
    if (id != null) {
  ...
  AddImageResponse._() : super();
  factory AddImageResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AddImageResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AddImageResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'image'), createEmptyInstance: create)
    ..aInt64(1, _omitFieldNames ? '' : 'id')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  AddImageResponse clone() => AddImageResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AddImageResponse copyWith(void Function(AddImageResponse) updates) => super.copyWith((message) => updates(message as AddImageResponse)) as AddImageResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AddImageResponse create() => AddImageResponse._();
  AddImageResponse createEmptyInstance() => create();
  static $pb.PbList<AddImageResponse> createRepeated() => $pb.PbList<AddImageResponse>();
  @$core.pragma('dart2js:noInline')
  static AddImageResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AddImageResponse>(create);
  static AddImageResponse? _defaultInstance;
