...
class UserModel extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$5.Timestamp>(8, _omitFieldNames ? '' : 'birthDate',
        subBuilder: $5.Timestamp.create)
    ..aOM<$5.Timestamp>(9, _omitFieldNames ? '' : 'lastLoginTimestamp',
        subBuilder: $5.Timestamp.create)
    ..aOS(10, _omitFieldNames ? '' : 'ip')
    ..aOM<$5.Timestamp>(11, _omitFieldNames ? '' : 'registrationTimestamp',
        subBuilder: $5.Timestamp.create)
  ...
  @$pb.TagNumber(9)
  set lastLoginTimestamp($5.Timestamp v) {
    setField(9, v);
  }
  ...
  @$pb.TagNumber(11)
  set registrationTimestamp($5.Timestamp v) {
    setField(11, v);
  }
