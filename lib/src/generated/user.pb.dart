...
class UserModel extends $pb.GeneratedMessage {
  factory UserModel({
    ...
    $core.String? name,
    $core.String? surname,
    $12.NullableString? description,
    $12.NullableString? location,
    $12.NullableString? email,
    $12.NullableString? phone,
    $fixnum.Int64? profileImageId,
    $fixnum.Int64? headerImageId,
    $12.NullableTimestamp? birthDate,
    $12.NullableTimestamp? registrationTimestamp,
    $12.NullableTimestamp? lastLoginTimestamp,
    $12.NullableString? ip,
    $core.int? followers,
    $core.int? following,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserModel', package: const $pb.PackageName(_omitMessageNames ? '' : 'user'), createEmptyInstance: create)
    ...
    ..aOM<$12.NullableString>(5, _omitFieldNames ? '' : 'description', subBuilder: $12.NullableString.create)
    ..aOM<$12.NullableString>(6, _omitFieldNames ? '' : 'location', subBuilder: $12.NullableString.create)
    ..aOM<$12.NullableString>(7, _omitFieldNames ? '' : 'email', subBuilder: $12.NullableString.create)
    ..aOM<$12.NullableString>(8, _omitFieldNames ? '' : 'phone', subBuilder: $12.NullableString.create)
    ..aInt64(9, _omitFieldNames ? '' : 'profileImageId')
    ..aInt64(10, _omitFieldNames ? '' : 'headerImageId')
    ..aOM<$12.NullableTimestamp>(11, _omitFieldNames ? '' : 'birthDate', subBuilder: $12.NullableTimestamp.create)
    ..aOM<$12.NullableTimestamp>(12, _omitFieldNames ? '' : 'registrationTimestamp', subBuilder: $12.NullableTimestamp.create)
    ..aOM<$12.NullableTimestamp>(13, _omitFieldNames ? '' : 'lastLoginTimestamp', subBuilder: $12.NullableTimestamp.create)
    ..aOM<$12.NullableString>(14, _omitFieldNames ? '' : 'ip', subBuilder: $12.NullableString.create)
  ...
  @$pb.TagNumber(5)
  $12.NullableString get description => $_getN(4);
  @$pb.TagNumber(5)
  set description($12.NullableString v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDescription() => $_has(4);
  @$pb.TagNumber(5)
  void clearDescription() => clearField(5);
  @$pb.TagNumber(5)
  $12.NullableString ensureDescription() => $_ensure(4);

  @$pb.TagNumber(6)
  $12.NullableString get location => $_getN(5);
  @$pb.TagNumber(6)
  set location($12.NullableString v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasLocation() => $_has(5);
  @$pb.TagNumber(6)
  void clearLocation() => clearField(6);
  @$pb.TagNumber(6)
  $12.NullableString ensureLocation() => $_ensure(5);

  @$pb.TagNumber(7)
  $12.NullableString get email => $_getN(6);
  @$pb.TagNumber(7)
  set email($12.NullableString v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasEmail() => $_has(6);
  @$pb.TagNumber(7)
  void clearEmail() => clearField(7);
  @$pb.TagNumber(7)
  $12.NullableString ensureEmail() => $_ensure(6);

  @$pb.TagNumber(8)
  $12.NullableString get phone => $_getN(7);
  @$pb.TagNumber(8)
  set phone($12.NullableString v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasPhone() => $_has(7);
  @$pb.TagNumber(8)
  void clearPhone() => clearField(8);
  @$pb.TagNumber(8)
  $12.NullableString ensurePhone() => $_ensure(7);
  ...
  @$pb.TagNumber(11)
  $12.NullableTimestamp get birthDate => $_getN(10);
  @$pb.TagNumber(11)
  set birthDate($12.NullableTimestamp v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasBirthDate() => $_has(10);
  @$pb.TagNumber(11)
  void clearBirthDate() => clearField(11);
  @$pb.TagNumber(11)
  $12.NullableTimestamp ensureBirthDate() => $_ensure(10);

  @$pb.TagNumber(12)
  $12.NullableTimestamp get registrationTimestamp => $_getN(11);
  @$pb.TagNumber(12)
  set registrationTimestamp($12.NullableTimestamp v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasRegistrationTimestamp() => $_has(11);
  @$pb.TagNumber(12)
  void clearRegistrationTimestamp() => clearField(12);
  @$pb.TagNumber(12)
  $12.NullableTimestamp ensureRegistrationTimestamp() => $_ensure(11);

  @$pb.TagNumber(13)
  $12.NullableTimestamp get lastLoginTimestamp => $_getN(12);
  @$pb.TagNumber(13)
  set lastLoginTimestamp($12.NullableTimestamp v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasLastLoginTimestamp() => $_has(12);
  @$pb.TagNumber(13)
  void clearLastLoginTimestamp() => clearField(13);
  @$pb.TagNumber(13)
  $12.NullableTimestamp ensureLastLoginTimestamp() => $_ensure(12);

  @$pb.TagNumber(14)
  $12.NullableString get ip => $_getN(13);
  @$pb.TagNumber(14)
  set ip($12.NullableString v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasIp() => $_has(13);
  @$pb.TagNumber(14)
  void clearIp() => clearField(14);
  @$pb.TagNumber(14)
  $12.NullableString ensureIp() => $_ensure(13);
...
class RegisterRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RegisterRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'user'), createEmptyInstance: create)
    ...
    ..aOM<$10.Timestamp>(7, _omitFieldNames ? '' : 'birthDate', subBuilder: $10.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $10.Timestamp get birthDate => $_getN(6);
  @$pb.TagNumber(7)
  set birthDate($10.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasBirthDate() => $_has(6);
  @$pb.TagNumber(7)
  void clearBirthDate() => clearField(7);
  @$pb.TagNumber(7)
  $10.Timestamp ensureBirthDate() => $_ensure(6);
}
...
class UpdateProfileRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateProfileRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'user'), createEmptyInstance: create)
    ...
    ..aOM<$10.Timestamp>(5, _omitFieldNames ? '' : 'birthDate', subBuilder: $10.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $10.Timestamp get birthDate => $_getN(4);
  @$pb.TagNumber(5)
  set birthDate($10.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasBirthDate() => $_has(4);
  @$pb.TagNumber(5)
  void clearBirthDate() => clearField(5);
  @$pb.TagNumber(5)
  $10.Timestamp ensureBirthDate() => $_ensure(4);
}
...
class GetUserByLoginRequest extends $pb.GeneratedMessage {
  ...
  factory GetUserByLoginRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetUserByLoginRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetUserByLoginRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'user'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'login')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetUserByLoginRequest clone() => GetUserByLoginRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetUserByLoginRequest copyWith(void Function(GetUserByLoginRequest) updates) => super.copyWith((message) => updates(message as GetUserByLoginRequest)) as GetUserByLoginRequest;
  ...
  static $pb.PbList<GetUserByLoginRequest> createRepeated() => $pb.PbList<GetUserByLoginRequest>();
  @$core.pragma('dart2js:noInline')
  static GetUserByLoginRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetUserByLoginRequest>(create);
...
class GetUserByLoginResponse extends $pb.GeneratedMessage {
  ...
  factory GetUserByLoginResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetUserByLoginResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetUserByLoginResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'user'), createEmptyInstance: create)
    ..aOM<UserModel>(1, _omitFieldNames ? '' : 'user', subBuilder: UserModel.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetUserByLoginResponse clone() => GetUserByLoginResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetUserByLoginResponse copyWith(void Function(GetUserByLoginResponse) updates) => super.copyWith((message) => updates(message as GetUserByLoginResponse)) as GetUserByLoginResponse;
  ...
  static $pb.PbList<GetUserByLoginResponse> createRepeated() => $pb.PbList<GetUserByLoginResponse>();
  @$core.pragma('dart2js:noInline')
  static GetUserByLoginResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetUserByLoginResponse>(create);
