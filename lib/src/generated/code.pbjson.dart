...
final $typed_data.Uint8List addEmailVerificationCodeRequestDescriptor =
...
final $typed_data.Uint8List addEmailVerificationCodeResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List verifyEmailVerificationCodeRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List verifyEmailVerificationCodeResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List addPhoneVerificationCodeRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List addPhoneVerificationCodeResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List verifyPhoneVerificationCodeRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List verifyPhoneVerificationCodeResponseDescriptor =
    $convert.base64Decode(
        'CiNWZXJpZnlQaG9uZVZlcmlmaWNhdGlvbkNvZGVSZXNwb25zZRIaCgh2ZXJpZmllZBgBIAEoCF'
        'IIdmVyaWZpZWQ=');

@$core.Deprecated(
    'Use addPasswordChangeVerificationCodeRequestDescriptor instead')
...
final $typed_data.Uint8List addPasswordChangeVerificationCodeRequestDescriptor =
    $convert.base64Decode(
...
@$core.Deprecated(
    'Use addPasswordChangeVerificationCodeResponseDescriptor instead')
...
final $typed_data.Uint8List
    addPasswordChangeVerificationCodeResponseDescriptor = $convert.base64Decode(
        'CilBZGRQYXNzd29yZENoYW5nZVZlcmlmaWNhdGlvbkNvZGVSZXNwb25zZRISCgRzZW50GAEgAS'
        'gIUgRzZW50');

@$core.Deprecated(
    'Use verifyPasswordChangeVerificationCodeRequestDescriptor instead')
...
final $typed_data.Uint8List
    verifyPasswordChangeVerificationCodeRequestDescriptor =
    $convert.base64Decode(
...
@$core.Deprecated(
    'Use verifyPasswordChangeVerificationCodeResponseDescriptor instead')
...
final $typed_data.Uint8List
    verifyPasswordChangeVerificationCodeResponseDescriptor =
    $convert.base64Decode(
        'CixWZXJpZnlQYXNzd29yZENoYW5nZVZlcmlmaWNhdGlvbkNvZGVSZXNwb25zZRIaCgh2ZXJpZm'
        'llZBgBIAEoCFIIdmVyaWZpZWQ=');

@$core.Deprecated(
    'Use addAccountDeletionVerificationCodeRequestDescriptor instead')
...
final $typed_data.Uint8List
    addAccountDeletionVerificationCodeRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List addAccountDeletionCodeResponseDescriptor =
    $convert.base64Decode(
        'Ch5BZGRBY2NvdW50RGVsZXRpb25Db2RlUmVzcG9uc2USEgoEc2VudBgBIAEoCFIEc2VudA==');

@$core.Deprecated(
    'Use verifyAccountDeletionVerificationCodeRequestDescriptor instead')
...
final $typed_data.Uint8List
    verifyAccountDeletionVerificationCodeRequestDescriptor =
    $convert.base64Decode(
...
@$core.Deprecated(
    'Use verifyAccountDeletionVerificationCodeResponseDescriptor instead')
...
final $typed_data.Uint8List
    verifyAccountDeletionVerificationCodeResponseDescriptor =
    $convert.base64Decode(
