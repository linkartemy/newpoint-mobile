...
class GrpcCommentClient extends $grpc.Client {
  static final _$getCommentsByPostId =
      $grpc.ClientMethod<$6.GetCommentsByPostIdRequest, $1.Response>(
  ...
  $grpc.ResponseFuture<$1.Response> getCommentsByPostId(
      $6.GetCommentsByPostIdRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getCommentsByPostId, request, options: options);
  }

  $grpc.ResponseFuture<$1.Response> getCommentById(
      $6.GetCommentByIdRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getCommentById, request, options: options);
  }

  $grpc.ResponseFuture<$1.Response> addComment($6.AddCommentRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$addComment, request, options: options);
  }

  $grpc.ResponseFuture<$1.Response> deleteComment(
      $6.DeleteCommentRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteComment, request, options: options);
  }

  $grpc.ResponseFuture<$1.Response> likeComment($6.LikeCommentRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$likeComment, request, options: options);
  }

  $grpc.ResponseFuture<$1.Response> unLikeComment(
      $6.UnLikeCommentRequest request,
      {$grpc.CallOptions? options}) {
  ...
  GrpcCommentServiceBase() {
    $addMethod($grpc.ServiceMethod<$6.GetCommentsByPostIdRequest, $1.Response>(
        ...
        ($core.List<$core.int> value) =>
            $6.GetCommentsByPostIdRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$6.GetCommentByIdRequest, $1.Response>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $6.GetCommentByIdRequest.fromBuffer(value),
        ($1.Response value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$6.DeleteCommentRequest, $1.Response>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $6.DeleteCommentRequest.fromBuffer(value),
        ($1.Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$6.LikeCommentRequest, $1.Response>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $6.LikeCommentRequest.fromBuffer(value),
        ($1.Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$6.UnLikeCommentRequest, $1.Response>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $6.UnLikeCommentRequest.fromBuffer(value),
        ($1.Response value) => value.writeToBuffer()));
  }

  $async.Future<$1.Response> getCommentsByPostId_Pre($grpc.ServiceCall call,
      $async.Future<$6.GetCommentsByPostIdRequest> request) async {
    return getCommentsByPostId(call, await request);
  }

  $async.Future<$1.Response> getCommentById_Pre($grpc.ServiceCall call,
      $async.Future<$6.GetCommentByIdRequest> request) async {
    return getCommentById(call, await request);
  }

  $async.Future<$1.Response> addComment_Pre($grpc.ServiceCall call,
      $async.Future<$6.AddCommentRequest> request) async {
    return addComment(call, await request);
  }

  $async.Future<$1.Response> deleteComment_Pre($grpc.ServiceCall call,
      $async.Future<$6.DeleteCommentRequest> request) async {
    return deleteComment(call, await request);
  }

  $async.Future<$1.Response> likeComment_Pre($grpc.ServiceCall call,
      $async.Future<$6.LikeCommentRequest> request) async {
    return likeComment(call, await request);
  }

  $async.Future<$1.Response> unLikeComment_Pre($grpc.ServiceCall call,
      $async.Future<$6.UnLikeCommentRequest> request) async {
    return unLikeComment(call, await request);
  }

  $async.Future<$1.Response> getCommentsByPostId(
      $grpc.ServiceCall call, $6.GetCommentsByPostIdRequest request);
  $async.Future<$1.Response> getCommentById(
      $grpc.ServiceCall call, $6.GetCommentByIdRequest request);
  $async.Future<$1.Response> addComment(
      $grpc.ServiceCall call, $6.AddCommentRequest request);
  $async.Future<$1.Response> deleteComment(
      $grpc.ServiceCall call, $6.DeleteCommentRequest request);
  $async.Future<$1.Response> likeComment(
      $grpc.ServiceCall call, $6.LikeCommentRequest request);
  $async.Future<$1.Response> unLikeComment(
      $grpc.ServiceCall call, $6.UnLikeCommentRequest request);
}
